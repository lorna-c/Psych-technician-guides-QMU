...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\LCamus\\OneDrive - Queen Margaret University\\Lab stuff\\psychopy-doc\\posner-tutorial\\posner_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('block-design-spreadsheets/blocks.xlsx'),
